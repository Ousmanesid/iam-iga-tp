...
echo ""
echo "🌐 URLs d'accès:"
echo "   - MidPoint:   http://localhost:8080/midpoint (administrator / Test5ecr3t)"
echo "   - Odoo ERP:   http://localhost:8069 (admin / admin)"
echo "   - N8N:        http://localhost:5678 (admin / admin123)"
echo "   - Gateway:    http://localhost:8000/docs"
echo "   - Intranet:   http://localhost:8090"
echo "   - LDAP:       ldap://localhost:10389 (cn=admin,dc=example,dc=com / admin)"
echo ""
